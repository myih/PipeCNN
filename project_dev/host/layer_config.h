...
#define NUM_CONFIG_ITEM  26 //26 after adding dilate conv
#define test
...
conv_x, conv_y, conv_z, conv_stride, conv_padding, conv_split, dilate_rate(1=normal), conv_relu, //Conv Parameters // conv_z=weight_m
...
unsigned input_config[5] = {5, 5, 1, 1}; //original image size(dim1, dim2, dim3), batch size

unsigned output_config[3] = {1, 1, 96};//Layer-1

char precision_config[][3] ={{0, 0, 0}//Layer-1
							};
#endif
